            ...
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              <Row className="mb-5">
                <Col>
                    ...
                    <div className="d-flex justify-content-around">
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            type="checkbox"
                            onChange={(event)=> this.checkedBox(event)}
                  ...
                  <Form.Check
                    inline
                    label=" I certify that i have read & accept Package details sheet
                  ...
                  <Tabs
                    ...
                    justify
                  >
                    <Tab eventKey="Cheque" title="Cheque/DD">
                      <div>
                        <Row className="my-4">
                          <Col md={6} lg={6}>
                            <Form.Label className="fw-bold ">
                    ...
                    <Tab eventKey="NEFT" title="NEFT/RTGS">
                      <Row className="my-4">
                        <Col md={6} lg={6}>
                          <Form.Label className="fw-bold ">
                            Account No.:
                    ...
                    <Tab eventKey="Credit Card" title="Credit Card">
                      ...
                      <Form>
                        ...
                        <h6 className="text-left">
                          Note : Credit card Payment is not available at this
                          moment.
                        </h6>
                      </Form>
                    </Tab>
                    <Tab eventKey="Cash" title="Cash"></Tab>
                  </Tabs>
                </Col>
              </Row>
