        ...
        >
          ...
          <div id="invoiceCapture" className="m-2">
            ...
            <div className="p-4">
              ...
              <Row className=" align-items-center py-2 border-bottom border-dark">
                <Col  className="border-end border-dark">
                  <div className="d-flex">
                    <h6 className="fw-bold">Location/Landmark :&nbsp; </h6>
              ...
              <Row className=" align-items-center py-2 border-bottom border-dark ">
                <Col>
                  <h6 className="fw-bold ">Product & Service Detail :&nbsp;</h6>
              ...
              <Table>
                <tbody>
                  ...
                  <tr className="text-end">
                    <td className="border-1"><span className="fw-bold">Payment in words:</span>{" "}
                      {numWords(this.props.info.total)}</td>
                    <td className="fw-bold" style={{ width: "100px" }}>
                      TOTAL
                    </td>
                    <td className="text-end" style={{ width: "100px" }}>
              ...
              {this.props.info.title === "Cheque" ? (
                ...
                <Row>
                  ...
                  <div className="d-flex">
                      ...
                      <h6 className="">{this.props.info.TransactionId || ""}</h6>
                    </div>
              ...
              <Row className="d-flex mx-4">
                <Col lg={12}>
                  <div className="my-4">
                    ...
                    <h6>GSTIN No. 27AUOPK6002E1ZS</h6>
                  </div>
                </Col>
                <Col md={4} lg={3}>
                ...
                <Col md={4} lg={3}>
                  <div className="sign-detail">
                    ...
                    <h6 style={{ textDecoration: "overline" }}>Approved By</h6>
                  </div>
                </Col>
                <Col md={4} lg={3}>
                  <div className="sign-detail">
                ...
                <Col md={4} lg={3}>
                  <div className="sign-detail">
                    <span></span>
                    <h6 style={{ textDecoration: "overline" }}>Designation</h6>
                  </div>
                </Col>
              </Row>
              <Row>
                <Col>
                  <div className="bg-light">
                    <h6 className="text-center m-0 p-2">
                      ...
                      floor, Nano Wing, Sector 30A, Vashi, Navi Mumbai,
                      Maharashtra 400703
                    </h6>
                  </div>
                </Col>
